package hamSanApp;
	...
	public class Point implements Comparable<Point>{
		...
		/**
		 * vergleichsfunktion. 
		 * DafÃ¼r da, um zwei Geraden an der x- Stelle value zu vergleichen.
		 */ 
		...
		/**
		 * gibt zurï¿½ck, ob sich die Geraden i und j oberhalb der Geraden k schneiden oder unterhalb
		 ...
		 * i,j,k und l mï¿½ssen sich unterscheiden!
